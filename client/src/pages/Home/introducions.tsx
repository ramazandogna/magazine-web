...
function Introducions() {
  return (
    <div className="relative flex h-[90vh] items-center justify-center">
      <div className="max-w-75% duration-400 hover:scale-103  globalRounded bg-bkg/30 globalPadding gap-22px z-1 relative flex flex-col shadow-xl transition-all hover:shadow-2xl">
      ...
      <Link
        to={'/about'}
        className=" fixed bottom-5 flex animate-bounce  cursor-pointer flex-col items-center justify-center"
      >
        <span className="text-bkg text-14px  mb-10px font-bold opacity-50">About</span>
